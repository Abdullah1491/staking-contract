...
pub trait StakingContract {
    ...
    fn calculate_rewards(&self, staking_position: &StakingPosition<Self::Api>) -> BigUint<Self::Api> {
        let current_block = self.blockchain().get_block_nonce();
    ...
    fn calculate_rewards_for_user(&self, addr: ManagedAddress) -> BigUint<Self::Api> {
    ...
    #[upgrade]
    fn upgrade(&self, new_apr: u64) {
        self.apy().set(new_apr);
    }
}
