...
use staking_contract::*; // Updated from staking-smart to staking-contract

// Constantlar
const WASM_PATH: &'static str = "output/staking-contract.wasm"; // Updated from staking-smart.wasm
...
where
    ContractObjBuilder: 'static + Copy + Fn() -> staking_contract::ContractObj<DebugApi>, // Updated from staking-smart
{
    pub b_mock: BlockchainStateWrapper,
    pub owner_address: Address,
    pub user_address: Address,
    pub contract_wrapper:
        ContractObjWrapper<staking_contract::ContractObj<DebugApi>, ContractObjBuilder>, // Updated from staking-smart
}
...
#[test]
fn rewards_test() {
    let mut setup = ContractSetup::new(staking_contract::contract_obj); // Updated from staking-smart
